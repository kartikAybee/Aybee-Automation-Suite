...
public class LoginSteps {
    ...
    private void signUpNewUser() {
        // Fresh Mailosaur address — unique per run so each execution creates a clean account.
        ...
        // Navigate directly to BASE_URL — the default landing state is the sign-up form.
        // Do NOT click toggle-sign-in; that would switch to the login form.
        ...
        // OTP verification page appears after successful sign-up.
        ...
        // Onboarding questions appear after OTP activation for all new accounts.
        new OnboardingPage().completeRequired();

        // Dashboard landmark — same element used by the sign-in flow.
