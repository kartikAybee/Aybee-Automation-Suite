...
public class NewExperimentPopup extends BasePage {
    ...
    private final By d2cSection                = By.id("newexperiment_productdevelopment_d2cshop_section");
    ...
    public NewExperimentPopup selectProductDevelopmentUseCase() {
        ...
        new WebDriverWait(driver, 30)
                .until(ExpectedConditions.visibilityOfElementLocated(d2cSection));
        return this;
    }

    @Step("Select D2C test type")
    public NewExperimentPopup selectD2C() {
        wait.until(ExpectedConditions.presenceOfElementLocated(d2cSection));
        jsClick(d2cSection);
        new WebDriverWait(driver, 30)
