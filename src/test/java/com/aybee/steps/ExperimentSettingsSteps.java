...
public class ExperimentSettingsSteps {
    ...
    private static final String STUDY_OBJECTIVE = "Evaluate consumer purchase intent and price sensitivity for our new product line across key demographic segments in the US marketplace to inform go-to-market strategy.";
