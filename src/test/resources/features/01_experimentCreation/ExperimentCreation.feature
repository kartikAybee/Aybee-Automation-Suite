@experimentCreation
Feature: Create a New Experiment on Aybee Platform

  Background:
    Given I am signed in as a valid user

  @case1
  Scenario: Create a Marketplace Simulation experiment for Product Development targeting the United States
